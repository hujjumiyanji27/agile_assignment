...
<div class="cci_footer_row cci_content_wrapper">
                <div class="cci_footer_menus_cont">
                    <div id="cci_footer_menu_one" class="cci_footer_menus">
                        <h3 style="color:blue;">Get in Touch</h3><h3>
...
<li id="menu-item-52" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-52"><a target="_blank" rel="noopener" href="https://twitter.com/ChiCIGroup">Twitter</a></li>
</ul>
</div>                    
</h3></div>
                    <div id="cci_footer_menu_two" class="cci_footer_menus">
                        <h3 style="color:green;">Primary Links</h3><h3>
                        <div class="menu-primary-links-container"><ul id="menu-primary-links-2" class="menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item menu-item-753"><a href="https://chici.org/" aria-current="page">Home</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-759"><a href="https://chici.org/contact/">Contact</a></li>
                    ...
                    <div id="cci_footer_menu_three" class="cci_footer_menus">
                        <h3 style="color:red;">Useful Resources</h3><h3>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="https://chici.org/ux-playbook/">UX Playbook</a></li>
                    ...
                    <div id="cci_footer_menu_four" class="cci_footer_menus">
                        <h3 style="color:red;">Guests</h3><h3>
