...
<body>
  ...
  <div style="text-align: center; margin-top: 20px;">
    <button style="background-color: #007bff; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 5px;">
        <a href="https://vesta.uclan.ac.uk/~hmmiyanji/agile/scheduling/staff_dashboard/show_availability.php" style="color: white; text-decoration: none;">Submit Your Availability</a>
    </button>
</div>
...
<div style="text-align: center; margin-top: 20px;">
    <button style="background-color: #007bff; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 5px;">
        <a href="https://vesta.uclan.ac.uk/~hmmiyanji/agile/scheduling/staff_dashboard/session_feedback.php" style="color: white; text-decoration: none;">Session Feedback</a>
    </button>
</div>
